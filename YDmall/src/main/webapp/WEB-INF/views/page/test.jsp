...
<head>
    ...
    <!-- Main CSS-->
    <link href="boardCss/css/main.css" rel="stylesheet" media="all">
</head>
        ...
        <div class="wrapper wrapper--w900">
            <div class="card card-6">
                ...
                <div class="card-footer">
                    <button class="btn btn--radius-2 btn--blue-2" type="submit" style="margin-left:500px">Send Application</button>
                </div>
            </div>
        </div>
    </div>
