...
<body>
	<div align="center">
		...
		<div>
			...
			<button type="button" onclick="location.href='qnaSelectList.yd'">뒤로 가기</button>
			&nbsp;&nbsp;
			<button type="button" onclick="insertReply(replyContent.value)" style="cursor:pointer">덧글 등록</button>
		</div>
	</div>
	<div>
